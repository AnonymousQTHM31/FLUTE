...
In particular, we use a DP accountant from another repository, which is included in ours as a submodule. For using this accountant, just follow the instructions below:
...
This software includes [model implementations](https://github.com/FedML-AI/FedML/tree/master/python/fedml/model) and [datasets](https://github.com/FedML-AI/FedML/tree/master/python/fedml/data) from FedML: The Community Building Open and Collaborative AI Anywhere at Any Scale (https://github.com/FedML-AI/FedML) to reproduce the benchmarking experiments: `cv_lr_mnist`, `cv_resnet_fedcifar100`, `cv_cnn_femnist`and `nlp_rnn_fedshakespeare`.
